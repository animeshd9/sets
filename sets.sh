...
host_name=$(hostname)
SYSTEM_INFO="{ \"name\": \"$host_name\", \"CPU\": \"$cpu_name\", \"GPU\": \"$gpu_name\", \"RAM\": \"$ram_size\" }"
...
"
echo -e "────────────────────────────────"
echo -e "| Local-instance Setup Wizard  |"
echo -e "────────────────────────────────\n"
...
if command -v docker &> /dev/null; then
    ...
    apt install docker-ce docker-ce-cli containerd.io docker-buildx-plugin docker-compose-plugin -yqq &> /dev/null
...
[Unit]
Description=Sets Docker Container
